...
echo "Payload manifest: dist/plushie-package.toml"
echo "Payload archive:  dist/payload.tar.zst"
echo ""
echo "Build launcher with:"
echo "  bin/plushie package portable --manifest dist/plushie-package.toml"
